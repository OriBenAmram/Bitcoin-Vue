<template>
    <header class="app-header" :class="{ isSignupPage: isSignupPage }">
        <div class="screen-overlay" :class="{ open: isMenuOpen }" @click="toggleMenu"></div>
        <div class="header-content">
            <router-link class="logo" :class="{ disable: isSignupPage }" to="/home">BITcorn</router-link>
            ...
            <button class="hamburger-btn" @click="toggleMenu">Ham</button>
        </div>
    </header>
</template>
